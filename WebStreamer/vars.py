...
class Var(object):
    ...
    HAS_SSL = str(environ.get("HAS_SSL", "0").lower()) in {
        "1",
        "true",
        "t",
        "yes",
    ...
    NO_PORT = str(environ.get("NO_PORT", "0").lower()) in {
        "1",
        "true",
        "t",
        "yes",
    ...
    KEEP_ALIVE = str(environ.get("KEEP_ALIVE", "0").lower()) in {
        "1",
        "true",
        "t",
        "yes",
    ...
    DEBUG = str(environ.get("DEBUG", "0").lower()) in {
        "1",
        "true",
        "t",
        "yes",
